...
|---|---|---|---|---|---|---|---|
| 1 | Qwen3-4B vanilla full attention | failed | N/A | 0.0 B | 0.0 B | 0.0 | 0.000 |
| 2 | Qwen3-4B + δ-Mem adapter | failed | N/A | 0.0 B | 0.0 B | 0.0 | 0.000 |
...
| 6 | Qwen3-4B + spec-decode | failed | N/A | 0.0 B | 0.0 B | 0.0 | 0.000 |
| 7 | Qwen3-4B + δ-Mem + spec-decode | failed | N/A | 0.0 B | 0.0 B | 0.0 | 0.000 |
